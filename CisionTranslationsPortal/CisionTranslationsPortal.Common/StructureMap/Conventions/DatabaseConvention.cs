...
{
    public class DatabaseConvention : IRegistrationConvention
    {
        #region IRegistrationConvention Members

        public void Process(Type type, Registry registry)
        {
            if (type != null && !string.IsNullOrEmpty(type.Namespace) && type.Namespace.Contains("Cision.CisionPoint.Database"))
            {
